...
### Last updated: 2026-04-26 | Version: V3 session
...
### Station network
MKEA: Mauna Kea HI (19.801, -155.456, 3763m)
KOKB: Kokee Kauai HI (22.127, -159.665, 1167m)
HNLC: Honolulu HI (21.297, -157.816, 5m)
GUAM: Guam (13.489, 144.868, 83m)
CHAT: Chatham Islands NZ (-43.956, -176.566, 63m)
THTI/THTG: Tahiti (-17.577, -149.606, 87m)
...
## NEXT PRIORITIES (V3 continuation)

1. **Focal mechanism score into combined_confidence** — currently ShakeMap is hard gate only. tsunamigenic_index (0-1) should weight tec_contrib as prior.

2. **Station expansion** — CORS Pacific stations, NZ IGS network for South Pacific coverage.

3. **Adaptive thresholds** — post-backtest Bayesian update on SNR_THRESHOLD, SPEED_MIN/MAX.

4. **ML classifier** — BLOCKED until ~30 scored live events.

5. **NHESS publication** — need ~10 scored live events, then write Technical Note.
