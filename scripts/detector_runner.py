...
def _rinex_existing_path(rinex_dir, station_code, doy, yr2, ftype):
    base = rinex_dir / f"{station_code}{doy:03d}0.{yr2}{ftype}"
    for ext in (".Z", ".gz"):
        p = Path(str(base) + ext)
        if p.exists():
            return p
...
def run_event(event, kp_override=None):
    ...
    for sid in STATIONS:
        ...
        for year, doy, yr2, resolved in rinex_days:
            ...
            og = _rinex_existing_path(rinex_dir, station_code, doy, yr2, "o")
            ng = _rinex_existing_path(rinex_dir, station_code, doy, yr2, "n")
    ...
    for _const in ('R', 'E'):
        ...
        for _sid in STATIONS:
            ...
            for _year, _doy, _yr2, _resolved in rinex_days:
                ...
                _og = _rinex_existing_path(rinex_dir, _station_code, _doy, _yr2, "o")
