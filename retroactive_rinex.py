...
def queue_retroactive_reprocess(event: dict, reason: str, probe: dict) -> dict:
    """Annotate for retroactive download while preserving current scored state."""
    ...
    # The CDDIS listing probe can be ahead of actual downloadable files; only
    # clear the old detector/scorer result after replacement files are present.
