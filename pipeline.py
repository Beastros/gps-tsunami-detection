        ...
        if once:
            ...
            if _fast:
                ...
                if os.environ.get("CI", "").lower() == "true":
                    log.info(f"FAST POLL MODE active for Mw{_mag} {_place}; CI --once exits without sleep loop")
